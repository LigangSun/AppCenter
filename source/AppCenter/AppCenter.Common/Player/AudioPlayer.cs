...
namespace SoonLearning.AppCenter.Player
{
  /// <summary>
  ...
  /// </summary>
    public class AudioPlayer : DispatcherObject
    {
        ...
        private DispatcherTimer lazyStartPlaybackEndedTimer = null;
        ...
        public void Play()
        {
            try
            {
                ...
                if (this.lazyStartPlaybackEndedTimer == null)
                {
                    this.lazyStartPlaybackEndedTimer = new DispatcherTimer();
                    this.lazyStartPlaybackEndedTimer.Interval = TimeSpan.FromMilliseconds(1000);
                    this.lazyStartPlaybackEndedTimer.Tick += ((s, e) =>
                    {
                        this.lazyStartPlaybackEndedTimer.Stop();
                        this.LazyPlay();
                    });
                }

                this.lazyStartPlaybackEndedTimer.Start();
            }
            catch
            {
            }
        ...
        private void LazyPlay()
        {
            ...
            {
                this.m_playbackEndedTimer = null;
