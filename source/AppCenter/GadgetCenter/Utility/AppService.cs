...
namespace SoonLearning.AppCenter.Utility
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace = "http://www.soonlearning.com/", ConfigurationName = "Utility.AppServerSoap")]
    public interface AppServerSoap
    {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        void AddApp(SoonLearning.AppCenter.Utility.APKSoftModel app, string userId, string password, string key);
        ...
        [System.ServiceModel.OperationContractAttribute(Action = "http://www.soonlearning.com/GetAppTopic", ReplyAction = "*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults = true)]
        UserPaidInfo GetUserPaidInfo(string appUniqueId, string userId, string password, string key);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface AppServerSoapChannel : SoonLearning.AppCenter.Utility.AppServerSoap, System.ServiceModel.IClientChannel
    {
    }

    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AppService : System.ServiceModel.ClientBase<SoonLearning.AppCenter.Utility.AppServerSoap>, SoonLearning.AppCenter.Utility.AppServerSoap
    {
        ...
        public AppService(string endpointConfigurationName) :
            base(endpointConfigurationName)
        {
        }

        public AppService(string endpointConfigurationName, string remoteAddress) :
            base(endpointConfigurationName, remoteAddress)
        {
        }

        public AppService(string endpointConfigurationName, System.ServiceModel.EndpointAddress remoteAddress) :
            base(endpointConfigurationName, remoteAddress)
        {
        }

        public AppService(System.ServiceModel.Channels.Binding binding, System.ServiceModel.EndpointAddress remoteAddress) :
        ...
        public void AddApp(SoonLearning.AppCenter.Utility.APKSoftModel app, string userId, string password, string key)
        {
        ...
        public UserPaidInfo GetUserPaidInfo(string appUniqueId, string userId, string password, string key)
        {
            return base.Channel.GetUserPaidInfo(appUniqueId, userId, password, key);
        }
    }
}
