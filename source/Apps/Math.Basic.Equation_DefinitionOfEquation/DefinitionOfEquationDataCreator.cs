...
{
    public class DefinitionOfEquationDataCreator : DataCreator
    {
        private static DefinitionOfEquationDataCreator creator;

        public static DefinitionOfEquationDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DefinitionOfEquationDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Equation_DefinitionOfEquation.DefinitionOfEquationFlowDocument.xaml";
