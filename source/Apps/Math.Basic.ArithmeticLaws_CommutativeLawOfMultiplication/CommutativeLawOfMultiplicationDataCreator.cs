...
{
    public class CommutativeLawOfMultiplicationDataCreator : DataCreator
    {
        private static CommutativeLawOfMultiplicationDataCreator creator;

        public static CommutativeLawOfMultiplicationDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CommutativeLawOfMultiplicationDataCreator();
        ...
        {
            this.exerciseTitle = "乘法交换律练习";
            this.examTitle = "乘法交换律测验";
            this.flowDocumentFile = "SoonLearning.Math.ArithmeticLaws_CommutativeLawOfMultiplication.CommutativeLawOfMultiplicationFlowDocument.xaml";
        ...
        private void CreateMCQuestion(SectionBaseInfo info, Section section)
        {
            ...
            string questionText = "从下面选项中选出符合乘法交换律的等式。";
            ...
            mcQuestion.Solution.Content = string.Format("{0}×{1}={1}×{0}，在这个等式中，交换两个因数{0}和{1}的位置，乘积不变，都是{2}。\n是符合乘法交换律的，是正确答案。", valueA, valueB, result);
        ...
        private void CreateTableQuestion(SectionBaseInfo info, Section section)
        {
            ...
            string questionText = "从表格中选择符合乘法交换律条件的等式";
