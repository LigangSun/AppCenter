...
{
     public class PrimeNumberDataCreator : DataCreator
    {
         private static PrimeNumberDataCreator creator;

         public static PrimeNumberDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new PrimeNumberDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.examTitle = "质数测验";
            this.flowDocumentFile = "SoonLearning.Math.Integer_PrimeNumber.PrimeNumberDocument.xaml";
