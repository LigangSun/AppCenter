...
{
    public class MultiplicationDataCreator : DataCreator
    {
        private static MultiplicationDataCreator creator;

        public static MultiplicationDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new MultiplicationDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.examTitle = "乘法测验";
            this.flowDocumentFile = "SoonLearning.Math.Arithmetic_Multiplication.MultiplicationFlowDocument.xaml";
