...
{
    public class FormOfDecimalDataCreator : DataCreator
    {
        private static FormOfDecimalDataCreator creator;

        public static FormOfDecimalDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new FormOfDecimalDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Decimal_FormOfDecimal.FormOfDecimalDocument.xaml";
