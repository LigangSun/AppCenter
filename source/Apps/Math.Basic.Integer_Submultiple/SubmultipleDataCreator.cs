...
{
    public class SubmultipleDataCreator : DataCreator
    {
        private static SubmultipleDataCreator creator;

        public static SubmultipleDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SubmultipleDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.examTitle = "约数测验";
            this.flowDocumentFile = "SoonLearning.Math.Integer_Submultiple.SubmultipleDocument.xaml";
