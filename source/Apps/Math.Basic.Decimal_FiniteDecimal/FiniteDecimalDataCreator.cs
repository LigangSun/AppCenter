...
{
    public class FiniteDecimalDataCreator : DataCreator
    {
        private static FiniteDecimalDataCreator creator;

        public static FiniteDecimalDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new FiniteDecimalDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Decimal_FiniteDecimal.FiniteDecimalDocument.xaml";
