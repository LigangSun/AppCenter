...
{
    public class WithDecimalDataCreator : DataCreator
    {
        private static WithDecimalDataCreator creator;

        public static WithDecimalDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new WithDecimalDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Decimal_WithDecimal.WithDecimalDocument.xaml";
