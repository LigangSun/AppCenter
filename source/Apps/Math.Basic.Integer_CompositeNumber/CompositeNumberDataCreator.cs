...
{
     public class CompositeNumberDataCreator : DataCreator
    {
         private static CompositeNumberDataCreator creator;

         public static CompositeNumberDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CompositeNumberDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.examTitle = "合数测验";
            this.flowDocumentFile = "SoonLearning.Math.Integer_CompositeNumber.CompositeNumberDocument.xaml";
