...
namespace SoonLearning.Math.Integer_CommonDivisor
{
    public class Entry : AssessmentBasicEntry
    {
        ...
        {
            get { return @"pack://application:,,,/SoonLearning.Math.Integer_CommonDivisor;component/integer.png"; }
        }
        ...
        public override System.Windows.UIElement GetStartupPage()
        {
            ...
            DataMgr.Instance.DataFolder = Path.Combine(Path.GetDirectoryName(location), @"Data\Integer\CommonDivision");
