...
namespace SoonLearning.BlockPuzzle._3x3
{
    public class Puzzle3x3Entry : MarshalByRefObject, IGadgetEntry, IAuthorInfo
    {
        ...
        public UIElement GetStartupPage()
        {
            ...
            //string[] files = Directory.GetFiles(@"C:\Users\Ligang\SkyDrive\Content Shared\Puzzle\33Resize", "*.*");
        ...
        public string Thumbnail
        {
            get
            {
                return @"pack://application:,,,/SoonLearning.BlockPuzzle._3x3;component/Puzzle_3x3.png";
            }
        }
