...
namespace Math.Basic.Data.Equation
{
    internal class MulOfSamePowerExponentDataCreator : DataCreator
    {
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "Math.Basic.Data.Equation.MulOfSamePowerExponentFlowDocument.xaml";
        ...
        protected override void AppendQuestion(SectionBaseInfo info, SoonLearning.Math.Data.Section section)
        {
            ...
            switch (info.QuestionType)
            {
                ...
                case QuestionType.FillInBlank:
                    ...
                    {
                        this.CreateFIBQuestionOnlyAnswer(info, section);
                    }
                    break;
        ...
        private void CreateFIBQuestionOnlyAnswer(SectionBaseInfo info, Section section)
        {
            int minValue = 10;
            int maxValue = 100;
            if (info is SectionValueRangeInfo)
        ...
        private void CreateTableQuestion(SectionBaseInfo info, Section section)
        {
            ...
            string questionText = "从表格中选择符合同底数幂的乘法条件的等式";
