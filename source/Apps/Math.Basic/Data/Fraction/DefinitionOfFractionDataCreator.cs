...
namespace Math.Basic.Data.Fraction
{
    internal class DefinitionOfFractionDataCreator : DataCreator
    {
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "Math.Basic.Data.Fraction.DefinitionOfFractionFlowDocument.xaml";
        ...
        {
            foreach (QuestionOption temp in ObjectCreator.CreateFractionOption(minValue, maxValue, minValue, maxValue))
            {
                optionList.Add(temp);
