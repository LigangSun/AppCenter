...
{
     public class OddNumberDataCreator : DataCreator
    {
         private static OddNumberDataCreator creator;

         public static OddNumberDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new OddNumberDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.examTitle = "奇数测验";
            this.flowDocumentFile = "SoonLearning.Math.Integer_OddNumber.OddNumberDocument.xaml";
