...
{
     public class DecompoundPrimeFactorDataCreator : DataCreator
    {
         private static DecompoundPrimeFactorDataCreator creator;

         public static DecompoundPrimeFactorDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DecompoundPrimeFactorDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Integer_DecompoundPrimeFactor.DecompoundPrimeFactorDocument.xaml";
