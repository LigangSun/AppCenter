...
{
    public class CoprimenumbersDataCreator : DataCreator
    {
        private static CoprimenumbersDataCreator creator;

        public static CoprimenumbersDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CoprimenumbersDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Integer_Coprimenumbers.CoprimenumbersDocument.xaml";
