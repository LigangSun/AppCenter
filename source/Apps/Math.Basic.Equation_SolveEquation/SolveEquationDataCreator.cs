...
{
    public class SolveEquationDataCreator : DataCreator
    {
        private static SolveEquationDataCreator creator;

        public static SolveEquationDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SolveEquationDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Equation_SolveEquation.SolveEquationFlowDocument.xaml";
