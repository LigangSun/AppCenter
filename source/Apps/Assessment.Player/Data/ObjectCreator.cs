...
namespace SoonLearning.Assessment.Player.Data
{
    ...
    {
        public static Exercise CreateExercise(string title, string description)
        {
        ...
        public static Exam CreateExam(string title, string description, int duration)
        {
            Exam exam = new Exam();
            exam.Title = title;
        ...
        public static Section CreateSection(string title, string description)
        {
        ...
        public static MCQuestion CreateMCQuestion(CreateQuestionContentDelegate bodyCallback, CreateQuestionOptionDelegate optionCallback)
        {
        ...
        public static TableQuestion CreateTableQuestion(CreateQuestionContentDelegate bodyCallback, CreateQuestionOptionDelegate optionCallback)
        {
        ...
        public static IEnumerable<QuestionOption> CreateDecimalOptions(int optionCount, 
            int minValue,
            int maxValue, 
            bool isMR,
        ...
        public static IEnumerable<QuestionOption> CreateFractionOptions(int optionCount,
            int minValue,
            int maxValue,
            bool isMR,
        ...
        public static IEnumerable<QuestionOption> CreateArithmeticFractionOption(int minNumeratorValue, int maxNumeratorValue, int minDenominatorValue, int maxDenominatorValue)
        {
            ArithmeticFractionValuePart fractionValue = null;
        ...
        public static IEnumerable<QuestionOption> CreateDoubleOption(int leftMinValue, int leftMaxValue, int rightMinValue, int rightMaxValue)
        {
            ArithmeticDecimalValuePart decimalValue = null;
        ...
        public static IEnumerable<QuestionOption> CreateDoubleTextOption(int leftMinValue, int leftMaxValue, int rightMinValue, int rightMaxValue, string suffix)
        {
