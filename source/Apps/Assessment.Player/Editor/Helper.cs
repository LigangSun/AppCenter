...
namespace SoonLearning.Assessment.Player.Editor
{
    internal class Helper
    {
        ...
        private static string DataPath
        {
            get
            {
                if (string.IsNullOrEmpty(dataPath))
                {
                    ...
                    dataPath = Path.GetDirectoryName(assembly.Location);
        ...
        internal static string ImagePath
        {
            get
            {
                string imagePath = System.IO.Path.Combine(DataPath, "Images");
        ...
        {
            return System.IO.Path.Combine(Helper.ImagePath, id + ".png");
        }
