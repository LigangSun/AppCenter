...
{
    public class CommonMultipleDataCreator : DataCreator
    {
        private static CommonMultipleDataCreator creator;

        public static CommonMultipleDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CommonMultipleDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Integer_CommonMultiple.CommonMultipleDocument.xaml";
