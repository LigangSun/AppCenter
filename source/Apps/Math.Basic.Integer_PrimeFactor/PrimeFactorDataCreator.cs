...
{
     public class PrimeFactorDataCreator : DataCreator
    {
         private static PrimeFactorDataCreator creator;

         public static PrimeFactorDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new PrimeFactorDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Integer_PrimeFactor.PrimeFactorDocument.xaml";
