...
{
    public class SubtractionDataCreator : DataCreator
    {
        private static SubtractionDataCreator creator;

        public static SubtractionDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SubtractionDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.examTitle = "减法测验";
            this.flowDocumentFile = "SoonLearning.Math.Arithmetic_Subtraction.SubtractionFlowDocument.xaml";
