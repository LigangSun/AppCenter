...
{
    public class CharacterOfSubtractionDataCreator : DataCreator
    {
        private static CharacterOfSubtractionDataCreator creator;

        public static CharacterOfSubtractionDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CharacterOfSubtractionDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.ArithmeticLaws_CharacterOfSubtraction.CharacterOfSubtractionFlowDocument.xaml";
