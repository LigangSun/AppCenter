...
{
    public class MultipleDataCreator : DataCreator
    {
        private static MultipleDataCreator creator;

        public static MultipleDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new MultipleDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.examTitle = "倍数测验";
            this.flowDocumentFile = "SoonLearning.Math.Integer_Multiple.MultipleDocument.xaml";
