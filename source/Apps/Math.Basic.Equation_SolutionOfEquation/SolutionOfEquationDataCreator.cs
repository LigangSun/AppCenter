...
{
    public class SolutionOfEquationDataCreator : DataCreator
    {
        private static SolutionOfEquationDataCreator creator;

        public static SolutionOfEquationDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SolutionOfEquationDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Equation_SolutionOfEquation.SolutionOfEquationFlowDocument.xaml";
