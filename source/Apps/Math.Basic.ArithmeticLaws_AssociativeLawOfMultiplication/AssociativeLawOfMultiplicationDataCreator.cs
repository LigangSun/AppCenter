...
{
    public class AssociativeLawOfMultiplicationDataCreator : DataCreator
    {
        private static AssociativeLawOfMultiplicationDataCreator creator;

        public static AssociativeLawOfMultiplicationDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new AssociativeLawOfMultiplicationDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.ArithmeticLaws_AssociativeLawOfMultiplication.AssociativeLawOfMultiplicationFlowDocument.xaml";
        ...
        private void CreateMCQuestion(SectionBaseInfo info, Section section)
        {
            ...
            string questionText = "从下面选项中选出符合乘法结合律的等式。";
            ...
            mcQuestion.Solution.Content = string.Format("({0} × {1}) × {2} = {0} × ({1} × {2})，在这个等式中，两边积不变，都是{3}。\n是符合乘法结合律的，是正确答案。", valueA, valueB, valueC, result);
        ...
        private void CreateTableQuestion(SectionBaseInfo info, Section section)
        {
            ...
            string questionText = "从表格中选择符合乘法结合律条件的等式";
