...
{
    public class DefinitionOfFractionDataCreator : DataCreator
    {
        private static DefinitionOfFractionDataCreator creator;

        public static DefinitionOfFractionDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DefinitionOfFractionDataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math.Fraction_DefinitionOfFraction.DefinitionOfFractionFlowDocument.xaml";
        ...
        public DefinitionOfFractionDataCreator()
        {
