...
{
    public class DivisionDataCreator : DataCreator
    {
        private static DivisionDataCreator creator;

        public static DivisionDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DivisionDataCreator();
