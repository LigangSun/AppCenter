...
{
    public class WSHB_129DataCreator : DataCreator
    {
        private static WSHB_129DataCreator creator;

        public static WSHB_129DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new WSHB_129DataCreator();
        ...
        {
            this.exerciseTitle = "尾数互补法练习";
            this.examTitle = "尾数互补法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.WSHB_129.WSHB_129_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int b1 = rand.Next(0, 10); //十位数
            int c1 = rand.Next(1, 10); //个位数
            int a2 = rand.Next(1, 10); //百位数
            int b2 = rand.Next(0, 10); //十位数
            int c2 = 10 - c1;// rand.Next(0, 10); //个位数
            int d1 = 0;
            int d2 = 0;
            ...
            if (posRand == 0)
            {
                ...
                A2 = A1 + 10 - c1 + c2;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
                A2 = 1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A1 = A2 + 10 - c1 + c2;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
