...
{
    public class JZQJ2_123DataCreator : DataCreator
    {
        private static JZQJ2_123DataCreator creator;

        public static JZQJ2_123DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JZQJ2_123DataCreator();
        ...
        {
            this.exerciseTitle = "近整求积法（二）练习";
            this.examTitle = "近整求积法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JZQJ2_123.JZQJ2_123_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            int baseNum = 100;
            int a1 = A1 / baseNum;
            int b1 = (A1 % baseNum) / 10;
            int c1 = (A1 % baseNum) % 10;
            int a2 = A2 / baseNum;
            int b2 = (A2 % baseNum) / 10;
            int c2 = (A2 % baseNum) % 10;
            ...
            //第二步 
            decimal A1a = A1 - b - 1;
            decimal ab100 = 100 - ab;
            calSteps += "=100×";
            calSteps += A1a.ToString();
            calSteps += "+";
            calSteps += ab100.ToString();
            
            //第三步 
            decimal A1a100 = 100 * A1a;
            calSteps += "=";
            calSteps += A1a100.ToString();
            calSteps += "+";
            calSteps += ab100.ToString();
