...
{
    public class JZQJ1_122DataCreator : DataCreator
    {
        private static JZQJ1_122DataCreator creator;

        public static JZQJ1_122DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JZQJ1_122DataCreator();
        ...
        {
            this.exerciseTitle = "近整求积法（一）练习";
            this.examTitle = "近整求积法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JZQJ1_122.JZQJ1_122_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            //第二步 
            decimal A1c2 = 100 *(A1 + c2);
            decimal A12c2 = A12 * c2;
            calSteps += "=";
            calSteps += A1c2.ToString();
            calSteps += "+";
            calSteps += A12c2.ToString();
