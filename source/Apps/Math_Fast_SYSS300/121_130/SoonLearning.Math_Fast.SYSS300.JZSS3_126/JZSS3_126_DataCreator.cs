...
namespace SoonLearning.Math_Fast.SYSS300.JZSS3_126
{
    public class JZSS3_126DataCreator : DataCreator
    {
        private static JZSS3_126DataCreator creator;

        public static JZSS3_126DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JZSS3_126DataCreator();
        ...
        {
            this.exerciseTitle = "近整速算法（三）练习";
            this.examTitle = "近整速算法（三）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JZSS3_126.JZSS3_126_Document.xaml";
