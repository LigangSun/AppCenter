...
{
    public class BSQJ_132DataCreator : DataCreator
    {
        private static BSQJ_132DataCreator creator;

        public static BSQJ_132DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new BSQJ_132DataCreator();
        ...
        {
            this.exerciseTitle = "补数求积法练习";
            this.examTitle = "补数求积法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.BSQJ_132.BSQJ_132_Document.xaml";
