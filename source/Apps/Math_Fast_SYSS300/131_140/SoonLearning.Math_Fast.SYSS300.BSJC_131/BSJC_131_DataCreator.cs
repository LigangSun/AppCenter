...
{
    public class BSJC_131DataCreator : DataCreator
    {
        private static BSJC_131DataCreator creator;

        public static BSJC_131DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new BSJC_131DataCreator();
        ...
        {
            this.exerciseTitle = "补数加乘法练习";
            this.examTitle = "补数加乘法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.BSJC_131.BSJC_131_Document.xaml";
