...
{
    public class HBQJ_133DataCreator : DataCreator
    {
        private static HBQJ_133DataCreator creator;

        public static HBQJ_133DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new HBQJ_133DataCreator();
        ...
        {
            this.exerciseTitle = "互补求积法练习";
            this.examTitle = "互补求积法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.HBQJ_133.HBQJ_133_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            else
            {
                ...
                A1 = 100 - (10 * b1 + c1); // 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
