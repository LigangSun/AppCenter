...
{
    public class ZZQJ1_134DataCreator : DataCreator
    {
        private static ZZQJ1_134DataCreator creator;

        public static ZZQJ1_134DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new ZZQJ1_134DataCreator();
        ...
        {
            this.exerciseTitle = "折整求积法（一）练习";
            this.examTitle = "折整求积法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.ZZQJ1_134.ZZQJ1_134_Document.xaml";
