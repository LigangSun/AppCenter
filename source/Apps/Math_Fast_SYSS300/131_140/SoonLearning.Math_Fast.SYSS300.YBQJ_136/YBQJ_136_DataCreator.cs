...
{
    public class YBQJ_136DataCreator : DataCreator
    {
        private static YBQJ_136DataCreator creator;

        public static YBQJ_136DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YBQJ_136DataCreator();
        ...
        {
            this.exerciseTitle = "隐蔽求积法练习";
            this.examTitle = "隐蔽求积法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YBQJ_136.YBQJ_136_Document.xaml";
