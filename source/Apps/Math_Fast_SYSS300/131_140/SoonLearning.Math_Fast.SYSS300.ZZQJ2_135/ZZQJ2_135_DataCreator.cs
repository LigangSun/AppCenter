...
{
    public class ZZQJ2_135DataCreator : DataCreator
    {
        private static ZZQJ2_135DataCreator creator;

        public static ZZQJ2_135DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new ZZQJ2_135DataCreator();
        ...
        {
            this.exerciseTitle = "折整求积法（二）练习";
            this.examTitle = "折整求积法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.ZZQJ2_135.ZZQJ2_135_Document.xaml";
