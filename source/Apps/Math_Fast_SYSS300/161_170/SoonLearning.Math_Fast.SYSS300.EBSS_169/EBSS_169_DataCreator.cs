...
{
    public class EBSS_169DataCreator : DataCreator
    {
        private static EBSS_169DataCreator creator;

        public static EBSS_169DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new EBSS_169DataCreator();
        ...
        {
            this.exerciseTitle = "21倍速算法练习";
            this.examTitle = "21倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.EBSS_169.EBSS_169_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 21;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
