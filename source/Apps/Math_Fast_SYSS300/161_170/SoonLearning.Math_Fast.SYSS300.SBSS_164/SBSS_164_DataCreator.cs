...
{
    public class SBSS_164DataCreator : DataCreator
    {
        private static SBSS_164DataCreator creator;

        public static SBSS_164DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_164DataCreator();
        ...
        {
            this.exerciseTitle = "11倍速算法练习";
            this.examTitle = "11倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_164.SBSS_164_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 11;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
