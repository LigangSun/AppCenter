...
{
    public class SBSS_165DataCreator : DataCreator
    {
        private static SBSS_165DataCreator creator;

        public static SBSS_165DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_165DataCreator();
        ...
        {
            this.exerciseTitle = "12倍速算法练习";
            this.examTitle = "12倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_165.SBSS_165_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 12;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
