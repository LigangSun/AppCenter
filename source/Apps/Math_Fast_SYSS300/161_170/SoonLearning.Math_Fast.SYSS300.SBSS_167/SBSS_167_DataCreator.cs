...
{
    public class SBSS_167DataCreator : DataCreator
    {
        private static SBSS_167DataCreator creator;

        public static SBSS_167DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_167DataCreator();
        ...
        {
            this.exerciseTitle = "18倍速算法练习";
            this.examTitle = "18倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_167.SBSS_167_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 18;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
