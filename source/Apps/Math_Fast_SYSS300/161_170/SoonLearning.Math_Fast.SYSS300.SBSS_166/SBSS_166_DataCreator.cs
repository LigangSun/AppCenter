...
{
    public class SBSS_166DataCreator : DataCreator
    {
        private static SBSS_166DataCreator creator;

        public static SBSS_166DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_166DataCreator();
        ...
        {
            this.exerciseTitle = "15倍速算法练习";
            this.examTitle = "15倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_166.SBSS_166_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 15;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
