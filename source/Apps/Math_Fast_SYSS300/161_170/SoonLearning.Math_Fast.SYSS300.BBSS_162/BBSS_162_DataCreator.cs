...
{
    public class BBSS_162DataCreator : DataCreator
    {
        private static BBSS_162DataCreator creator;

        public static BBSS_162DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new BBSS_162DataCreator();
        ...
        {
            this.exerciseTitle = "8倍速算法练习";
            this.examTitle = "8倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.BBSS_162.BBSS_162_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 8;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
