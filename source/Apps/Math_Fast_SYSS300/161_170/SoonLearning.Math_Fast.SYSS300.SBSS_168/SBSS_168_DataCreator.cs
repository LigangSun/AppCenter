...
{
    public class SBSS_168DataCreator : DataCreator
    {
        private static SBSS_168DataCreator creator;

        public static SBSS_168DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_168DataCreator();
        ...
        {
            this.exerciseTitle = "19倍速算法练习";
            this.examTitle = "19倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_168.SBSS_168_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 19;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
