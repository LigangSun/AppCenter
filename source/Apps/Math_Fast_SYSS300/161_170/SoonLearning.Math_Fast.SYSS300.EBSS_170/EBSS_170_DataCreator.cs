...
{
    public class EBSS_170DataCreator : DataCreator
    {
        private static EBSS_170DataCreator creator;

        public static EBSS_170DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new EBSS_170DataCreator();
        ...
        {
            this.exerciseTitle = "24倍速算法练习";
            this.examTitle = "24倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.EBSS_170.EBSS_170_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                A1 = 24;// rand.Next(minValue, maxValue + 1); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
