...
{
    public class JBSS_163DataCreator : DataCreator
    {
        private static JBSS_163DataCreator creator;

        public static JBSS_163DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JBSS_163DataCreator();
        ...
        {
            this.exerciseTitle = "9倍速算法练习";
            this.examTitle = "9倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JBSS_163.JBSS_163_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 9;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
