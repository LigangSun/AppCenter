...
{
    public class YBSS_185DataCreator : DataCreator
    {
        private static YBSS_185DataCreator creator;

        public static YBSS_185DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YBSS_185DataCreator();
        ...
        {
            this.exerciseTitle = "125倍速算法练习";
            this.examTitle = "125倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YBSS_185.YBSS_185_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 125;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
