...
{
    public class QBSS_181DataCreator : DataCreator
    {
        private static QBSS_181DataCreator creator;

        public static QBSS_181DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new QBSS_181DataCreator();
        ...
        {
            this.exerciseTitle = "77倍速算法练习";
            this.examTitle = "77倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.QBSS_181.QBSS_181_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 77;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
