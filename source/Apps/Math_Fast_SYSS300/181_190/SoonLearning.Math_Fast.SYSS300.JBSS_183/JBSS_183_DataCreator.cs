...
namespace SoonLearning.Math_Fast.SYSS300.JBSS_183
{
    public class JBSS_183DataCreator : DataCreator
    {
        private static JBSS_183DataCreator creator;

        public static JBSS_183DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JBSS_183DataCreator();
        ...
        {
            this.exerciseTitle = "91倍速算法练习";
            this.examTitle = "91倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JBSS_183.JBSS_183_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 91;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
