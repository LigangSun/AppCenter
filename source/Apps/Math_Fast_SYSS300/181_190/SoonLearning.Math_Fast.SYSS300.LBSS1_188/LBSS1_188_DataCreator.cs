...
{
    public class LBSS1_188DataCreator : DataCreator
    {
        private static LBSS1_188DataCreator creator;

        public static LBSS1_188DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LBSS1_188DataCreator();
        ...
        {
            this.exerciseTitle = "625倍速算法（一）练习";
            this.examTitle = "625倍速算法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LBSS1_188.LBSS1_188_Document.xaml";
