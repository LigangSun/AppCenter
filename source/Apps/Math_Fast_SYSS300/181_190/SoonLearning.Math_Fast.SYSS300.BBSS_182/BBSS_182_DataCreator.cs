...
{
    public class BBSS_182DataCreator : DataCreator
    {
        private static BBSS_182DataCreator creator;

        public static BBSS_182DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new BBSS_182DataCreator();
        ...
        {
            this.exerciseTitle = "83倍速算法练习";
            this.examTitle = "83倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.BBSS_182.BBSS_182_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 83;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
