...
{
    public class SBSS_187DataCreator : DataCreator
    {
        private static SBSS_187DataCreator creator;

        public static SBSS_187DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_187DataCreator();
        ...
        {
            this.exerciseTitle = "375倍速算法练习";
            this.examTitle = "375倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_187.SBSS_187_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 375;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
