...
namespace SoonLearning.Math_Fast.SYSS300.SBSS_186
{
    public class SBSS_186DataCreator : DataCreator
    {
        private static SBSS_186DataCreator creator;

        public static SBSS_186DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_186DataCreator();
        ...
        {
            this.exerciseTitle = "334倍速算法练习";
            this.examTitle = "334倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_186.SBSS_186_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 334;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
