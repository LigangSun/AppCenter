...
{
    public class FJQCDataCreator : DataCreator
    {
        private static FJQCDataCreator creator;

        public static FJQCDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new FJQCDataCreator();
        ...
        {
            this.exerciseTitle = "分解求差法练习";
            this.examTitle = "分解求差法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.FJQC.FJQC_Document.xaml";
        ...
        {        
            ...
            decimal AL = valueMC.AL;
            decimal AH = valueMC.AH;
         
            calSteps += "=(";
            calSteps += AH.ToString();
            calSteps += "-1)×100+";
            calSteps += AL.ToString();
            calSteps += "×2";
            ...
            calSteps += "+";
            decimal AL2 = AL * 2;
            calSteps += AL2.ToString();
          
            //第三步
            decimal answer = A2 + AL2;
