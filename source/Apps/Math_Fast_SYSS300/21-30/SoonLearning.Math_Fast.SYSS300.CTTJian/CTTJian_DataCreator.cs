...
{
    public class CTTJianDataCreator : DataCreator
    {
        private static CTTJianDataCreator creator;

        public static CTTJianDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CTTJianDataCreator();
        ...
        {
            this.exerciseTitle = "凑同调减法练习";
            this.examTitle = "凑同调减法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CTTJian.CTTJian_Document.xaml";
