...
{
    public class QCZJDataCreator : DataCreator
    {
        private static QCZJDataCreator creator;

        public static QCZJDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new QCZJDataCreator();
        ...
        {
            this.exerciseTitle = "求差直减法练习";
            this.examTitle = "求差直减法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.QCZJ.QCZJ_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int bits = 1;
            int i = 0;
            int tmpMaxValue = rand.Next(100, maxValue + 1);// / 10;
            ...
            decimal b1 = rand.Next(a1 + 1, a1 + 12);
            ...
            //随机取被减数B
            int bh = rand.Next(0, numsA[bits - 1]);
