...
{
    public class YCDC5_203DataCreator : DataCreator
    {
        private static YCDC5_203DataCreator creator;

        public static YCDC5_203DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDC5_203DataCreator();
        ...
        {
            this.exerciseTitle = "以乘代除法（五）练习";
            this.examTitle = "以乘代除法（五）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDC5_203.YCDC5_203_Document.xaml";
