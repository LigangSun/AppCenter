...
{
    public class YCDC7_205DataCreator : DataCreator
    {
        private static YCDC7_205DataCreator creator;

        public static YCDC7_205DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDC7_205DataCreator();
        ...
        {
            this.exerciseTitle = "以乘代除法（七）练习";
            this.examTitle = "以乘代除法（七）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDC7_205.YCDC7_205_Document.xaml";
