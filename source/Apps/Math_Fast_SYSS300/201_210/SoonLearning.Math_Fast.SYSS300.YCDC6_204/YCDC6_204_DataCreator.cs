...
{
    public class YCDC6_204DataCreator : DataCreator
    {
        private static YCDC6_204DataCreator creator;

        public static YCDC6_204DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDC6_204DataCreator();
        ...
        {
            this.exerciseTitle = "以乘代除法（六）练习";
            this.examTitle = "以乘代除法（六）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDC6_204.YCDC6_204_Document.xaml";
