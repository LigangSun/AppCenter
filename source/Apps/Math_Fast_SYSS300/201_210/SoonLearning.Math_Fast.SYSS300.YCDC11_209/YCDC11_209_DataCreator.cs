...
{
    public class YCDC11_209DataCreator : DataCreator
    {
        private static YCDC11_209DataCreator creator;

        public static YCDC11_209DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDC11_209DataCreator();
        ...
        {
            this.exerciseTitle = "以乘代除法（十一）练习";
            this.examTitle = "以乘代除法（十一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDC11_209.YCDC11_209_Document.xaml";
