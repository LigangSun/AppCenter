...
{
    public class YCDC12_210DataCreator : DataCreator
    {
        private static YCDC12_210DataCreator creator;

        public static YCDC12_210DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDC12_210DataCreator();
        ...
        {
            this.exerciseTitle = "以乘代除法（十二）练习";
            this.examTitle = "以乘代除法（十二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDC12_210.YCDC12_210_Document.xaml";
