...
{
    public class YCDC8_206DataCreator : DataCreator
    {
        private static YCDC8_206DataCreator creator;

        public static YCDC8_206DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDC8_206DataCreator();
        ...
        {
            this.exerciseTitle = "以乘代除法（八）练习";
            this.examTitle = "以乘代除法（八）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDC8_206.YCDC8_206_Document.xaml";
