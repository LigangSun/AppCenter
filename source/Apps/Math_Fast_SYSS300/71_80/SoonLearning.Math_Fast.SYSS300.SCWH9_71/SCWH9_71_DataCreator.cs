...
{
    public class SCWH9_71DataCreator : DataCreator
    {
        private static SCWH9_71DataCreator creator;

        public static SCWH9_71DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SCWH9_71DataCreator();
        ...
        {
            this.exerciseTitle = "首差尾合9法练习";
            this.examTitle = "首差尾合9法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SCWH9_71.SCWH9_71_Document.xaml";
