...
{
    public class S1Z0WY2_75DataCreator : DataCreator
    {
        private static S1Z0WY2_75DataCreator creator;

        public static S1Z0WY2_75DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S1Z0WY2_75DataCreator();
        ...
        {
            this.exerciseTitle = "首1中0尾异法（二）练习";
            this.examTitle = "首1中0尾异法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S1Z0WY2_75.S1Z0WY2_75_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            //第二步
            int BN = baseNum * baseNum;
            int Ba = baseNum * a;
            int Bb = baseNum * b;
            int ab = a * b;
            calSteps += "=";
            calSteps += BN.ToString();
            calSteps += "+";
            calSteps += Ba.ToString();
            calSteps += "+";
            calSteps += Bb.ToString();
            calSteps += "+";
            calSteps += ab.ToString();
