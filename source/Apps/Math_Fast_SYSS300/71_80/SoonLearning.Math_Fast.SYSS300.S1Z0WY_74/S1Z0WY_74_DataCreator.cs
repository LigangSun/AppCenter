...
{
    public class S1Z0WY_74DataCreator : DataCreator
    {
        private static S1Z0WY_74DataCreator creator;

        public static S1Z0WY_74DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S1Z0WY_74DataCreator();
        ...
        {
            this.exerciseTitle = "首1中0尾异法（一）练习";
            this.examTitle = "首1中0尾异法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S1Z0WY_74.S1Z0WY_74_Document.xaml";
