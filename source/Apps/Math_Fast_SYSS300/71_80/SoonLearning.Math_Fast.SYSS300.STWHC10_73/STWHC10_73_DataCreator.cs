...
{
    public class STWHC10_73DataCreator : DataCreator
    {
        private static STWHC10_73DataCreator creator;

        public static STWHC10_73DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STWHC10_73DataCreator();
        ...
        {
            this.exerciseTitle = "首同尾合超10法练习";
            this.examTitle = "首同尾合超10法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STWHC10_73.STWHC10_73_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            calSteps += "+";
            calSteps += b_d.ToString();
            int b_d_a = (b + d - 10) * a10;
            calSteps += "+";
            calSteps += b_d_a.ToString();
