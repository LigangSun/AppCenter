...
{
    public class S1Z0WY3_76DataCreator : DataCreator
    {
        private static S1Z0WY3_76DataCreator creator;

        public static S1Z0WY3_76DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S1Z0WY3_76DataCreator();
        ...
        {
            this.exerciseTitle = "首1中0尾异法（三）练习";
            this.examTitle = "首1中0尾异法（三）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S1Z0WY3_76.S1Z0WY3_76_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            decimal A, B;
            int bitNum = 4;// rand.Next(3, 5); //一百零几或一千零几
