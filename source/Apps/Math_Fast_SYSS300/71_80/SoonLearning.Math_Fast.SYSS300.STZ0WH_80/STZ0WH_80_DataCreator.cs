...
{
    public class STZ0WH_80DataCreator : DataCreator
    {
        private static STZ0WH_80DataCreator creator;

        public static STZ0WH_80DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STZ0WH_80DataCreator();
        ...
        {
            this.exerciseTitle = "首同中0尾合法练习";
            this.examTitle = "首同中0尾合法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STZ0WH_80.STZ0WH_80_Document.xaml";
