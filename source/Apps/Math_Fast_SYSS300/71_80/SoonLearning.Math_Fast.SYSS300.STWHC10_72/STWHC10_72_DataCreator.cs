...
{
    public class STWHC10_72DataCreator : DataCreator
    {
        private static STWHC10_72DataCreator creator;

        public static STWHC10_72DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STWHC10_72DataCreator();
        ...
        {
            this.exerciseTitle = "首同尾合次10法练习";
            this.examTitle = "首同尾合次10法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STWHC10_72.STWHC10_72_Document.xaml";
