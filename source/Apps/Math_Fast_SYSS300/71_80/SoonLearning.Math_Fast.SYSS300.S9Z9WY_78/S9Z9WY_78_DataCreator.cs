...
{
    public class S9Z9WY_78DataCreator : DataCreator
    {
        private static S9Z9WY_78DataCreator creator;

        public static S9Z9WY_78DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S9Z9WY_78DataCreator();
        ...
        {
            this.exerciseTitle = "首9中9尾异法练习";
            this.examTitle = "首9中9尾异法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S9Z9WY_78.S9Z9WY_78_Document.xaml";
