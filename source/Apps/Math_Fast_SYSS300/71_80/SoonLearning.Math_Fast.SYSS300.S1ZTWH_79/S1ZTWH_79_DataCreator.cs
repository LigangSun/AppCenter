...
{
    public class S1ZTWH_79DataCreator : DataCreator
    {
        private static S1ZTWH_79DataCreator creator;

        public static S1ZTWH_79DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S1ZTWH_79DataCreator();
        ...
        {
            this.exerciseTitle = "首1中同尾合法练习";
            this.examTitle = "首1中同尾合法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S1ZTWH_79.S1ZTWH_79_Document.xaml";
