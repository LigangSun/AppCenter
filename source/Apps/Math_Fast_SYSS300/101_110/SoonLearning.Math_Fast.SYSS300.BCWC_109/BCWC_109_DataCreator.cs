...
{
    public class BCWC_109DataCreator : DataCreator
    {
        private static BCWC_109DataCreator creator;

        public static BCWC_109DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new BCWC_109DataCreator();
        ...
        {
            this.exerciseTitle = "变乘为除法练习";
            this.examTitle = "变乘为除法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.BCWC_109.BCWC_109_Document.xaml";
