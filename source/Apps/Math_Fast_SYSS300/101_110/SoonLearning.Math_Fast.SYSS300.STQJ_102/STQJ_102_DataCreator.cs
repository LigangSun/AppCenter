...
{
    public class STQJ_102DataCreator : DataCreator
    {
        private static STQJ_102DataCreator creator;

        public static STQJ_102DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STQJ_102DataCreator();
        ...
        {
            this.exerciseTitle = "数同求积法练习";
            this.examTitle = "数同求积法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STQJ_102.STQJ_102_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int bitNum = rand.Next(2, 6);

            int a1 = 0;// rand.Next(1, 10); //百位数
            int b1 = rand.Next(2, 10); //十位数
            int c1 = 1;// rand.Next(1, 10); //个位数
            int a2 = 0;// rand.Next(1, 10); //百位数
            int b2 = b1 - 1;// rand.Next(1, 10); //十位数
            int c2 = 9;// rand.Next(1, 10); //个位数
            int d1 = 0;
            int d2 = 0;
            ...
            {
                valueABC.values[0] = A2;
                valueABC.values[1] = A1;
            }
