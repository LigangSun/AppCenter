...
{
    public class LSQJ_103DataCreator : DataCreator
    {
        private static LSQJ_103DataCreator creator;

        public static LSQJ_103DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LSQJ_103DataCreator();
        ...
        {
            this.exerciseTitle = "连数求积法练习";
            this.examTitle = "连数求积法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LSQJ_103.LSQJ_103_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            {
                A1 = 100 * a1 + 10 * b1 + c1;
                A2 = A1 + 1;// 100 * a2 + 10 * b2 + c2;
            }
            else
            {
                A2 = 100 * a1 + 10 * b1 + c1;
                A1 = A2 + 1;// 100 * a2 + 10 * b2 + c2;
            }
