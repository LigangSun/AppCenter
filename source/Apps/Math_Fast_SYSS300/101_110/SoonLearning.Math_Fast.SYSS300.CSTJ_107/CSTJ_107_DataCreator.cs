...
{
    public class CSTJ_107DataCreator : DataCreator
    {
        private static CSTJ_107DataCreator creator;

        public static CSTJ_107DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CSTJ_107DataCreator();
        ...
        {
            this.exerciseTitle = "凑数调减法练习";
            this.examTitle = "凑数调减法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CSTJ_107.CSTJ_107_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int b2 = rand.Next(2, 10); //十位数
            int c2 = rand.Next(1, b2); //个位数
            int d1 = 0;
            int d2 = 0;
