...
{
    public class TSCW_105DataCreator : DataCreator
    {
        private static TSCW_105DataCreator creator;

        public static TSCW_105DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new TSCW_105DataCreator();
        ...
        {
            this.exerciseTitle = "同数错位法练习";
            this.examTitle = "同数错位法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.TSCW_105.TSCW_105_Document.xaml";
