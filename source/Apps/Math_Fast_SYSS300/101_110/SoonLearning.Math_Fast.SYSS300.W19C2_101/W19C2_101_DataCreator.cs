...
{
    public class W19C2_101DataCreator : DataCreator
    {
        private static W19C2_101DataCreator creator;

        public static W19C2_101DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new W19C2_101DataCreator();
        ...
        {
            this.exerciseTitle = "尾1、9差2法练习";
            this.examTitle = "尾1、9差2法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.W19C2_101.W19C2_101_Document.xaml";
