...
{
    public class GSTJ_106DataCreator : DataCreator
    {
        private static GSTJ_106DataCreator creator;

        public static GSTJ_106DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new GSTJ_106DataCreator();
        ...
        {
            this.exerciseTitle = "挂数调加法练习";
            this.examTitle = "挂数调加法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.GSTJ_106.GSTJ_106_Document.xaml";
