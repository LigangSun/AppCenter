...
{
    public class STWY4_43DataCreator : DataCreator
    {
        private static STWY4_43DataCreator creator;

        public static STWY4_43DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STWY4_43DataCreator();
        ...
        {
            this.exerciseTitle = "首同尾异法（四）练习";
            this.examTitle = "首同尾异法（四）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STWY4_43.STWY4_43_Document.xaml";
