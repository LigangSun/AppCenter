...
{
    public class SWJY_47DataCreator : DataCreator
    {
        private static SWJY_47DataCreator creator;

        public static SWJY_47DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SWJY_47DataCreator();
        ...
        {
            this.exerciseTitle = "首尾均异法练习";
            this.examTitle = "首尾均异法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SWJY_47.SWJY_47_Document.xaml";
