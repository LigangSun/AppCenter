...
{
    public class SYWT1_44DataCreator : DataCreator
    {
        private static SYWT1_44DataCreator creator;

        public static SYWT1_44DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SYWT1_44DataCreator();
        ...
        {
            this.exerciseTitle = "首异尾同法（一）练习";
            this.examTitle = "首异尾同法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SYWT1_44.SYWT1_44_Document.xaml";
