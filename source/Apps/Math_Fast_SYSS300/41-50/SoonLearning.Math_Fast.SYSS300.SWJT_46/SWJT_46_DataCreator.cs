...
{
    public class SWJT_46DataCreator : DataCreator
    {
        private static SWJT_46DataCreator creator;

        public static SWJT_46DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SWJT_46DataCreator();
        ...
        {
            this.exerciseTitle = "首尾均同法练习";
            this.examTitle = "首尾均同法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SWJT_46.SWJT_46_Document.xaml";
