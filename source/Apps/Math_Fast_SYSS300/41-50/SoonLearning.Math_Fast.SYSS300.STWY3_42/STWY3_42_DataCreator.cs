...
{
    public class STWY3_42DataCreator : DataCreator
    {
        private static STWY3_42DataCreator creator;

        public static STWY3_42DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STWY3_42DataCreator();
        ...
        {
            this.exerciseTitle = "首同尾异法（三）练习";
            this.examTitle = "首同尾异法（三）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STWY3_42.STWY3_42_Document.xaml";
