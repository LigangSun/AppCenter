...
{
    public class STWY2_41DataCreator : DataCreator
    {
        private static STWY2_41DataCreator creator;

        public static STWY2_41DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STWY2_41DataCreator();
        ...
        {
            this.exerciseTitle = "首同尾异法（二）练习";
            this.examTitle = "首同尾异法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STWY2_41.STWY2_41_Document.xaml";
