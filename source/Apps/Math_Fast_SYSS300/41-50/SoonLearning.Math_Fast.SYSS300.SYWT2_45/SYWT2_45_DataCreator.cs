...
{
    public class SYWT2_45DataCreator : DataCreator
    {
        private static SYWT2_45DataCreator creator;

        public static SYWT2_45DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SYWT2_45DataCreator();
        ...
        {
            this.exerciseTitle = "首异尾同法（二）练习";
            this.examTitle = "首异尾同法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SYWT2_45.SYWT2_45_Document.xaml";
