...
{
    public class SHWT1_50DataCreator : DataCreator
    {
        private static SHWT1_50DataCreator creator;

        public static SHWT1_50DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SHWT1_50DataCreator();
        ...
        {
            this.exerciseTitle = "首合尾同法（一）练习";
            this.examTitle = "首合尾同法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SHWT1_50.SHWT1_50_Document.xaml";
