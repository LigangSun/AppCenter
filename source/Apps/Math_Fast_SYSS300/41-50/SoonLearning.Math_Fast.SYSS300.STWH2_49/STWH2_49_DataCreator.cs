...
{
    public class STWH2_49DataCreator : DataCreator
    {
        private static STWH2_49DataCreator creator;

        public static STWH2_49DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STWH2_49DataCreator();
        ...
        {
            this.exerciseTitle = "首同尾合法（二）练习";
            this.examTitle = "首同尾合法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STWH2_49.STWH2_49_Document.xaml";
