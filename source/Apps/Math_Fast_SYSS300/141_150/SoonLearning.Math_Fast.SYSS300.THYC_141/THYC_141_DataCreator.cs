...
{
    public class THYC_141DataCreator : DataCreator
    {
        private static THYC_141DataCreator creator;

        public static THYC_141DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new THYC_141DataCreator();
        ...
        {
            this.exerciseTitle = "退还一成法练习";
            this.examTitle = "退还一成法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.THYC_141.THYC_141_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = rand.Next(1, 10) * 9; ;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
                A2 = rand.Next(minValue, maxValue + 1); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A1 = rand.Next(1, 10) * 9; ;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
