...
{
    public class DJQJ_145DataCreator : DataCreator
    {
        private static DJQJ_145DataCreator creator;

        public static DJQJ_145DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DJQJ_145DataCreator();
        ...
        {
            this.exerciseTitle = "递加求积法练习";
            this.examTitle = "递加求积法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.DJQJ_145.DJQJ_145_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                A1 = rand.Next(minValue, 100 + 1); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A2 = 111;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
                A2 = rand.Next(minValue, 100 + 1); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A1 = 111;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
