...
{
    public class JXQJ_144DataCreator : DataCreator
    {
        private static JXQJ_144DataCreator creator;

        public static JXQJ_144DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JXQJ_144DataCreator();
        ...
        {
            this.exerciseTitle = "加项求积法练习";
            this.examTitle = "加项求积法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JXQJ_144.JXQJ_144_Document.xaml";
