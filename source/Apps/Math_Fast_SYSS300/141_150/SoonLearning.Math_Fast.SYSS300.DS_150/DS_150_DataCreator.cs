...
{
    public class DS_150DataCreator : DataCreator
    {
        private static DS_150DataCreator creator;

        public static DS_150DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DS_150DataCreator();
        ...
        {
            this.exerciseTitle = "倒算法练习";
            this.examTitle = "倒算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.DS_150.DS_150_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int c2 = rand.Next(1, 4); //个位数
            int b2 = rand.Next(1, 7); //十位数
            int a2 = rand.Next(c2, 10); //百位数
            int d1 = 0;
            int d2 = 0;
