...
{
    public class YCDJ1_146DataCreator : DataCreator
    {
        private static YCDJ1_146DataCreator creator;

        public static YCDJ1_146DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDJ1_146DataCreator();
        ...
        {
            this.exerciseTitle = "依次得积法（一）练习";
            this.examTitle = "依次得积法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDJ1_146.YCDJ1_146_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 101;// rand.Next(1, 10) * 9; ;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
                A2 = rand.Next(minValue, 100); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A1 = 101;// rand.Next(1, 10) * 9; ;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
