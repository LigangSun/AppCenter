...
{
    public class CFBC_142DataCreator : DataCreator
    {
        private static CFBC_142DataCreator creator;

        public static CFBC_142DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CFBC_142DataCreator();
        ...
        {
            this.exerciseTitle = "乘方补差法练习";
            this.examTitle = "乘方补差法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CFBC_142.CFBC_142_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int c1 = rand.Next(4, 6); //个位数
            int a2 = rand.Next(0, 10); //百位数
            ...
            if (posRand == 0)
            {
                ...
                {
                    tmp = decimal.ToInt32(A1) - 10;
                }
                A2 = rand.Next(tmp, decimal.ToInt32(A1) + 12); //A1 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
                ...
                {
                    tmp = decimal.ToInt32(A2) - 10;
                }
                A1 = rand.Next(tmp, decimal.ToInt32(A2) + 12); //A1 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
