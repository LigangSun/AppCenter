...
{
    public class YCDJ3_148DataCreator : DataCreator
    {
        private static YCDJ3_148DataCreator creator;

        public static YCDJ3_148DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDJ3_148DataCreator();
        ...
        {
            this.exerciseTitle = "依次得积法（三）练习";
            this.examTitle = "依次得积法（三）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDJ3_148.YCDJ3_148_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                A1 = rand.Next(minValue, 100); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A2 = 101 * baseNum;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
                A2 = rand.Next(minValue, 100); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A1 = 101 * baseNum;// rand.Next(1, 10) * 9; ;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
