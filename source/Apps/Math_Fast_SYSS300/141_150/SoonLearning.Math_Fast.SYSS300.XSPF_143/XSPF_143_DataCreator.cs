...
{
    public class XSPF_143DataCreator : DataCreator
    {
        private static XSPF_143DataCreator creator;

        public static XSPF_143DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new XSPF_143DataCreator();
        ...
        {
            this.exerciseTitle = "小数平方法练习";
            this.examTitle = "小数平方法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.XSPF_143.XSPF_143_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                A1 = rand.Next(11, 35); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A2 = 100 - A1; // rand.Next(1, 10) * 9; ;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
                A2 = rand.Next(101, 300); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A1 = 1000 - A2;// rand.Next(1, 10) * 9; ;// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
