...
namespace SoonLearning.Math_Fast.SYSS300.SBSS_174
{
    public class SBSS_174DataCreator : DataCreator
    {
        private static SBSS_174DataCreator creator;

        public static SBSS_174DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_174DataCreator();
        ...
        {
            this.exerciseTitle = "34倍速算法练习";
            this.examTitle = "34倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_174.SBSS_174_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 34;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
