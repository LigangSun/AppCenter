...
{
    public class LBSS_177DataCreator : DataCreator
    {
        private static LBSS_177DataCreator creator;

        public static LBSS_177DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LBSS_177DataCreator();
        ...
        {
            this.exerciseTitle = "66倍速算法练习";
            this.examTitle = "66倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LBSS_177.LBSS_177_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 66;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
