...
{
    public class EBSS_171DataCreator : DataCreator
    {
        private static EBSS_171DataCreator creator;

        public static EBSS_171DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new EBSS_171DataCreator();
        ...
        {
            this.exerciseTitle = "25倍速算法练习";
            this.examTitle = "25倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.EBSS_171.EBSS_171_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                A1 = 4 * rand.Next(minValue, maxValue + 1); //1000 * d1 + 100 * a1 + 10 * b1 + c1;
