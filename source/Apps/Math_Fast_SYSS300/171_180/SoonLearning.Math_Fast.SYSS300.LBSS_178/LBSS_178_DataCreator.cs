...
{
    public class LBSS_178DataCreator : DataCreator
    {
        private static LBSS_178DataCreator creator;

        public static LBSS_178DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LBSS_178DataCreator();
        ...
        {
            this.exerciseTitle = "67倍速算法练习";
            this.examTitle = "67倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LBSS_178.LBSS_178_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A1 = 67;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
