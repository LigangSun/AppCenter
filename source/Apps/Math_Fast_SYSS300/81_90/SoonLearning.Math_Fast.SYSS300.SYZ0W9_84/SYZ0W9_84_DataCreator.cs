...
{
    public class SYZ0W9_84DataCreator : DataCreator
    {
        private static SYZ0W9_84DataCreator creator;

        public static SYZ0W9_84DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SYZ0W9_84DataCreator();
        ...
        {
            this.exerciseTitle = "首异中0尾9法练习";
            this.examTitle = "首异中0尾9法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SYZ0W9_84.SYZ0W9_84_Document.xaml";
