...
{
    public class SYZ0W5_85DataCreator : DataCreator
    {
        private static SYZ0W5_85DataCreator creator;

        public static SYZ0W5_85DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SYZ0W5_85DataCreator();
        ...
        {
            this.exerciseTitle = "首异中0尾5法练习";
            this.examTitle = "首异中0尾5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SYZ0W5_85.SYZ0W5_85_Document.xaml";
