...
{
    public class CSZ0_90DataCreator : DataCreator
    {
        private static CSZ0_90DataCreator creator;

        public static CSZ0_90DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CSZ0_90DataCreator();
        ...
        {
            this.exerciseTitle = "乘数中0法练习";
            this.examTitle = "乘数中0法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CSZ0_90.CSZ0_90_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            //第二步
            int a1a2 = baseNum1 * a1 * baseNum1 * a2;
            calSteps += "=(";
            ...
            //第三步
            int a1a2c1c2 = a1a2 + c1c2;
            calSteps += "=";
            calSteps += a1a2c1c2.ToString();
            calSteps += "+";
            int a1c2a2c1 = a1c2 + a2c1;
            calSteps += a1c2a2c1.ToString();
            int b1a2b1c2 = b1a2 + b1c2;
            calSteps += "+";
            calSteps += b1a2b1c2.ToString();
