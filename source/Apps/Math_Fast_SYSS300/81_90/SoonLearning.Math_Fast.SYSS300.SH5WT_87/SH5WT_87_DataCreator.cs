...
{
    public class SH5WT_87DataCreator : DataCreator
    {
        private static SH5WT_87DataCreator creator;

        public static SH5WT_87DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SH5WT_87DataCreator();
        ...
        {
            this.exerciseTitle = "首合5尾同法练习";
            this.examTitle = "首合5尾同法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SH5WT_87.SH5WT_87_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int a1 = rand.Next(1, 5); //百位数
            int b1 = 0;// rand.Next(1, 10); //十位数
            int c1 = rand.Next(1, 10); //个位数
            int a2 = 5 - a1;// rand.Next(1, 10); //百位数
            ...
            {
                A1 = 100 * a1 + 00 * b1 + 0 * c1 + d1;
                A2 = 100 * a2 + 00 * b2 + 0 * c2 + d2;
            }
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            //第一步
            int a1_100 = baseNum * a1;
            calSteps += "=";
            calSteps += a1_100.ToString();
            calSteps += "×";
            int a2_100 = baseNum * a2;
            calSteps += a2_100.ToString();
            calSteps += "+(";
            calSteps += a1_100.ToString();
            calSteps += "+";
            calSteps += a2_100.ToString();
            ...
            //第二步
            int ab100_2 = a1_100 * a2_100;
            int ab100_3 = (a1_100 + a2_100) * c1;
            int cc = c1 * c2;
            calSteps += "=";
            calSteps += ab100_2.ToString();
            calSteps += "+";
            calSteps += ab100_3.ToString();
            calSteps += "+";
