...
{
    public class STZ9WH_81DataCreator : DataCreator
    {
        private static STZ9WH_81DataCreator creator;

        public static STZ9WH_81DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STZ9WH_81DataCreator();
        ...
        {
            this.exerciseTitle = "首同中9尾合法练习";
            this.examTitle = "首同中9尾合法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STZ9WH_81.STZ9WH_81_Document.xaml";
