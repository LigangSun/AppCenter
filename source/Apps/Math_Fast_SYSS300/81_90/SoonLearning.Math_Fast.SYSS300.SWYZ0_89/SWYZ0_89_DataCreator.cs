...
{
    public class SWYZ0_89DataCreator : DataCreator
    {
        private static SWYZ0_89DataCreator creator;

        public static SWYZ0_89DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SWYZ0_89DataCreator();
        ...
        {
            this.exerciseTitle = "首尾异中0法练习";
            this.examTitle = "首尾异中0法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SWYZ0_89.SWYZ0_89_Document.xaml";
