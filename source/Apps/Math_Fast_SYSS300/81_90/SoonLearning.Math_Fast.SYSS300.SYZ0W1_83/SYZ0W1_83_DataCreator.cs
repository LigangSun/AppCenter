...
{
    public class SYZ0W1_83DataCreator : DataCreator
    {
        private static SYZ0W1_83DataCreator creator;

        public static SYZ0W1_83DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SYZ0W1_83DataCreator();
        ...
        {
            this.exerciseTitle = "首异中0尾1法练习";
            this.examTitle = "首异中0尾1法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SYZ0W1_83.SYZ0W1_83_Document.xaml";
