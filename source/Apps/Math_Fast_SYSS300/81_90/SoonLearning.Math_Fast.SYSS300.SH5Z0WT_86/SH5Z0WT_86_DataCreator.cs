...
{
    public class SH5Z0WT_86DataCreator : DataCreator
    {
        private static SH5Z0WT_86DataCreator creator;

        public static SH5Z0WT_86DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SH5Z0WT_86DataCreator();
        ...
        {
            this.exerciseTitle = "首合5中0尾同法练习";
            this.examTitle = "首合5中0尾同法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SH5Z0WT_86.SH5Z0WT_86_Document.xaml";
