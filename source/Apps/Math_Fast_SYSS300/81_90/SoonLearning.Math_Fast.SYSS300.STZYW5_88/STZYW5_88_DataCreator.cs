...
{
    public class STZYW5_88DataCreator : DataCreator
    {
        private static STZYW5_88DataCreator creator;

        public static STZYW5_88DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STZYW5_88DataCreator();
        ...
        {
            this.exerciseTitle = "首同中异尾5法练习";
            this.examTitle = "首同中异尾5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STZYW5_88.STZYW5_88_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            calSteps += "×";
            int b2c2 = 10 * b2 + c2;
            calSteps += b2c2.ToString();
          
            //第二步
            calSteps += "=100×";
            int abc = a1 * (b1c1 + A2);
            calSteps += abc.ToString();
            calSteps += "+";
            int bc = b1c1 * b2c2;
            calSteps += bc.ToString();
           
            //第三步
            int abc100 = 100 * abc;
            calSteps += "=";
            calSteps += abc100.ToString();
            calSteps += "+";
            calSteps += bc.ToString();
