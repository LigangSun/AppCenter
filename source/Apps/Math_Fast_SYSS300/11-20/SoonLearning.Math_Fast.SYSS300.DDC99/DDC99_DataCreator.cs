...
{
    public class DDC99DataCreator : DataCreator
    {
        private static DDC99DataCreator creator;

        public static DDC99DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DDC99DataCreator();
        ...
        {
            this.exerciseTitle = "颠倒乘99法练习";
            this.examTitle = "颠倒乘99法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.DDC99.DDC99_Document.xaml";
