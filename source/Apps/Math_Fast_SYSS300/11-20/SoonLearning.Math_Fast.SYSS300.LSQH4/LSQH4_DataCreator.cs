...
{
    public class LSQH4DataCreator : DataCreator
    {
        private static LSQH4DataCreator creator;

        public static LSQH4DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LSQH4DataCreator();
        ...
        {
            this.exerciseTitle = "连数求和法(四)练习";
            this.examTitle = "连数求和法(四)测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LSQH4.LSQH4_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            valueABC.valueStart = 2;// rand.Next(minValue, maxValue + 1);
