...
{
    public class LSQH6DataCreator : DataCreator
    {
        private static LSQH6DataCreator creator;

        public static LSQH6DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LSQH6DataCreator();
        ...
        {
            this.exerciseTitle = "连数求和法(六)练习";
            this.examTitle = "连数求和法(六)测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LSQH6.LSQH6_Document.xaml";
