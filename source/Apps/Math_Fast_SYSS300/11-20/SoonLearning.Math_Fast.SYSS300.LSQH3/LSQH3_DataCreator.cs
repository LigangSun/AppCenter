...
{
    public class LSQH3DataCreator : DataCreator
    {
        private static LSQH3DataCreator creator;

        public static LSQH3DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LSQH3DataCreator();
        ...
        {
            this.exerciseTitle = "连数求和法(三)练习";
            this.examTitle = "连数求和法(三)测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LSQH3.LSQH3_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            valueABC.number = rand.Next(6, 100 + 1);
            ...
            valueABC.valueStart = 1;// rand.Next(minValue, maxValue + 1);
