...
{
    public class DDC9DataCreator : DataCreator
    {
        private static DDC9DataCreator creator;

        public static DDC9DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DDC9DataCreator();
        ...
        {
            this.exerciseTitle = "颠倒乘9法练习";
            this.examTitle = "颠倒乘9法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.DDC9.DDC9_Document.xaml";
