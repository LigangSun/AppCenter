...
{
    public class TZFP_231DataCreator : DataCreator
    {
        private static TZFP_231DataCreator creator;

        public static TZFP_231DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new TZFP_231DataCreator();
        ...
        protected override void PrepareSectionInfoCollection()
        {
            ...
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.TZFP_231.TZFP_231_Document.xaml";
