...
{
    public class CSS1_91DataCreator : DataCreator
    {
        private static CSS1_91DataCreator creator;

        public static CSS1_91DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CSS1_91DataCreator();
        ...
        {
            this.exerciseTitle = "乘数首1法练习";
            this.examTitle = "乘数首1法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CSS1_91.CSS1_91_Document.xaml";
