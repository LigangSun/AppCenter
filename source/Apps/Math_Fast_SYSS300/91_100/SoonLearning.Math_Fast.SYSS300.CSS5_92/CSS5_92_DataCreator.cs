...
namespace SoonLearning.Math_Fast.SYSS300.CSS5_92
{
    public class CSS5_92DataCreator : DataCreator
    {
        private static CSS5_92DataCreator creator;

        public static CSS5_92DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CSS5_92DataCreator();
        ...
        {
            this.exerciseTitle = "乘数首5法练习";
            this.examTitle = "乘数首5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CSS5_92.CSS5_92_Document.xaml";
