...
{
    public class WSF91_99DataCreator : DataCreator
    {
        private static WSF91_99DataCreator creator;

        public static WSF91_99DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new WSF91_99DataCreator();
        ...
        {
            this.exerciseTitle = "尾数逢9法（一）练习";
            this.examTitle = "尾数逢9法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.WSF91_99.WSF91_99_Document.xaml";
