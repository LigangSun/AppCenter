...
{
    public class S9WY1_94DataCreator : DataCreator
    {
        private static S9WY1_94DataCreator creator;

        public static S9WY1_94DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S9WY1_94DataCreator();
        ...
        {
            this.exerciseTitle = "首9尾异法（一）练习";
            this.examTitle = "首9尾异法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S9WY1_94.S9WY1_94_Document.xaml";
