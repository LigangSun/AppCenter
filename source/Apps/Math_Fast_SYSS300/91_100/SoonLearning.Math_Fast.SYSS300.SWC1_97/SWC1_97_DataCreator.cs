...
{
    public class SWC1_97DataCreator : DataCreator
    {
        private static SWC1_97DataCreator creator;

        public static SWC1_97DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SWC1_97DataCreator();
        ...
        {
            this.exerciseTitle = "首位差1法练习";
            this.examTitle = "首位差1法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SWC1_97.SWC1_97_Document.xaml";
