...
{
    public class SWH9_98DataCreator : DataCreator
    {
        private static SWH9_98DataCreator creator;

        public static SWH9_98DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SWH9_98DataCreator();
        ...
        {
            this.exerciseTitle = "首尾合9法练习";
            this.examTitle = "首尾合9法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SWH9_98.SWH9_98_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int b2 = rand.Next(1, 9); //十位数
            int c2 = 9 - b2;// rand.Next(1, 10); //个位数
            int d1 = 0;
            int d2 = 0;
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            //int A2_c1 = A2 + c1;
            //calSteps += "=";
            //calSteps += b1_10.ToString();
            //calSteps += "×";
            //calSteps += A2_c1.ToString();
            //calSteps += "-";
