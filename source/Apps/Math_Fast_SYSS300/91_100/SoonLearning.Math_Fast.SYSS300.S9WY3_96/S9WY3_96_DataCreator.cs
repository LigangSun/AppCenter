...
{
    public class S9WY3_96DataCreator : DataCreator
    {
        private static S9WY3_96DataCreator creator;

        public static S9WY3_96DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S9WY3_96DataCreator();
        ...
        {
            this.exerciseTitle = "首9尾异法（三）练习";
            this.examTitle = "首9尾异法（三）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S9WY3_96.S9WY3_96_Document.xaml";
