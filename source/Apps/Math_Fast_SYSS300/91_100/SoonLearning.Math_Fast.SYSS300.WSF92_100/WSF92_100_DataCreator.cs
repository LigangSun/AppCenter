...
{
    public class WSF92_100DataCreator : DataCreator
    {
        private static WSF92_100DataCreator creator;

        public static WSF92_100DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new WSF92_100DataCreator();
        ...
        {
            this.exerciseTitle = "尾数逢9法（二）练习";
            this.examTitle = "尾数逢9法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.WSF92_100.WSF92_100_Document.xaml";
