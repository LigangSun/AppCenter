...
{
    public class CSW5_93DataCreator : DataCreator
    {
        private static CSW5_93DataCreator creator;

        public static CSW5_93DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CSW5_93DataCreator();
        ...
        {
            this.exerciseTitle = "乘数尾5法练习";
            this.examTitle = "乘数尾5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CSW5_93.CSW5_93_Document.xaml";
