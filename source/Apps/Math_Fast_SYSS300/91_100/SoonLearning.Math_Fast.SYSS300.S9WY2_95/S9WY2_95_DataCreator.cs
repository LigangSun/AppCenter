...
{
    public class S9WY2_95DataCreator : DataCreator
    {
        private static S9WY2_95DataCreator creator;

        public static S9WY2_95DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S9WY2_95DataCreator();
        ...
        {
            this.exerciseTitle = "首9尾异法（二）练习";
            this.examTitle = "首9尾异法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S9WY2_95.S9WY2_95_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            int b210 = b2 * 10;
            calSteps += "=100×[100-(";
            calSteps += c1_10.ToString();
            calSteps += "+";
            calSteps += c2_10.ToString();
            calSteps += ")+";
            calSteps += c1_10.ToString();
            calSteps += "×";
            calSteps += c2_10.ToString();
            ...
            //第三步
            int A1_2 = 100 * (100 - (c1_10 + c2_10));
            int A2_2 = c1_10 * c2_10;
            calSteps += "=";
            calSteps += A1_2.ToString();
            calSteps += "+";
            calSteps += A2_2.ToString();
