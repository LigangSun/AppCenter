...
{
    public class LBSS_191DataCreator : DataCreator
    {
        private static LBSS_191DataCreator creator;

        public static LBSS_191DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LBSS_191DataCreator();
        ...
        {
            this.exerciseTitle = "667倍速算法练习";
            this.examTitle = "667倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LBSS_191.LBSS_191_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            else
            {
                ...
                A1 = (rand.Next(minValue, maxValue + 1) / 3) * 3; //1000 * d1 + 100 * a1 + 10 * b1 + c1;
                A2 = 667;// *(rand.Next(minValue + 1, maxValue + 1) / 5);// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
