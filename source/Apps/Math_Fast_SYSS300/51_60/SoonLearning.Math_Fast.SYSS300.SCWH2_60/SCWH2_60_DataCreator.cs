...
{
    public class SCWH2_60DataCreator : DataCreator
    {
        private static SCWH2_60DataCreator creator;

        public static SCWH2_60DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SCWH2_60DataCreator();
        ...
        {
            this.exerciseTitle = "首差尾合法（二）练习";
            this.examTitle = "首差尾合法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SCWH2_60.SCWH2_60_Document.xaml";
