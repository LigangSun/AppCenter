...
{
    public class SHWT2_51DataCreator : DataCreator
    {
        private static SHWT2_51DataCreator creator;

        public static SHWT2_51DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SHWT2_51DataCreator();
        ...
        {
            this.exerciseTitle = "首合尾同法（二）练习";
            this.examTitle = "首合尾同法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SHWT2_51.SHWT2_51_Document.xaml";
