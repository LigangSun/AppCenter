...
{
    public class SCWH1_59DataCreator : DataCreator
    {
        private static SCWH1_59DataCreator creator;

        public static SCWH1_59DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SCWH1_59DataCreator();
        ...
        {
            this.exerciseTitle = "首差尾合法（一）练习";
            this.examTitle = "首差尾合法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SCWH1_59.SCWH1_59_Document.xaml";
