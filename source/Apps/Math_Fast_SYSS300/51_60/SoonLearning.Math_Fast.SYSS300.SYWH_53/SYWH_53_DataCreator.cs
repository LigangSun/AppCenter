...
{
    public class SYWH_53DataCreator : DataCreator
    {
        private static SYWH_53DataCreator creator;

        public static SYWH_53DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SYWH_53DataCreator();
        ...
        {
            this.exerciseTitle = "首异尾合法练习";
            this.examTitle = "首异尾合法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SYWH_53.SYWH_53_Document.xaml";
