...
{
    public class SYW12_58DataCreator : DataCreator
    {
        private static SYW12_58DataCreator creator;

        public static SYW12_58DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SYW12_58DataCreator();
        ...
        {
            this.exerciseTitle = "首异尾1法（二）练习";
            this.examTitle = "首异尾1法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SYW12_58.SYW12_58_Document.xaml";
