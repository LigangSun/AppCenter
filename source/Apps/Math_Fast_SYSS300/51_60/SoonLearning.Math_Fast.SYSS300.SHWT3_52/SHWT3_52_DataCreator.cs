...
{
    public class SHWT3_52DataCreator : DataCreator
    {
        private static SHWT3_52DataCreator creator;

        public static SHWT3_52DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SHWT3_52DataCreator();
        ...
        {
            this.exerciseTitle = "首合尾同法（三）练习";
            this.examTitle = "首合尾同法（三）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SHWT3_52.SHWT3_52_Document.xaml";
