...
{
    public class SHWY_54DataCreator : DataCreator
    {
        private static SHWY_54DataCreator creator;

        public static SHWY_54DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SHWY_54DataCreator();
        ...
        {
            this.exerciseTitle = "首合尾异法练习";
            this.examTitle = "首合尾异法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SHWY_54.SHWY_54_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            calSteps += "+";
            calSteps += d100.ToString();
            calSteps += "+";
            calSteps += d_d.ToString();
            calSteps += "-";
            calSteps += error_B.ToString();
