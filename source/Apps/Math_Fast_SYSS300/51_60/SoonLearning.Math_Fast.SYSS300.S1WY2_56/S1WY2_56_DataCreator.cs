...
{
    public class S1WY2_56DataCreator : DataCreator
    {
        private static S1WY2_56DataCreator creator;

        public static S1WY2_56DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S1WY2_56DataCreator();
        ...
        {
            this.exerciseTitle = "首1尾异法（二）练习";
            this.examTitle = "首1尾异法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S1WY2_56.S1WY2_56_Document.xaml";
