...
{
    public class S1WY1_55DataCreator : DataCreator
    {
        private static S1WY1_55DataCreator creator;

        public static S1WY1_55DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S1WY1_55DataCreator();
        ...
        {
            this.exerciseTitle = "首1尾异法（一）练习";
            this.examTitle = "首1尾异法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S1WY1_55.S1WY1_55_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            int a_b_10 = 10 + a + b;
            calSteps += "=";
            calSteps += a_b_10.ToString();
            calSteps += "×10+";
            int a_b = a * b;
            calSteps += a_b.ToString();
        
            //第三步
            int a_b_10_10 = 10 * a_b_10;
            calSteps += "=";
            calSteps += a_b_10_10.ToString();
            calSteps += "+";
            calSteps += a_b.ToString();
