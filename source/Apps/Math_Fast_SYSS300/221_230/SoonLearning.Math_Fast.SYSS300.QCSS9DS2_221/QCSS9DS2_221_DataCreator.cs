...
{
    public class QCSS9DS2_221DataCreator : DataCreator
    {
        private static QCSS9DS2_221DataCreator creator;

        public static QCSS9DS2_221DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new QCSS9DS2_221DataCreator();
        ...
        {
            this.exerciseTitle = "求除数是9的商法（二）练习";
            this.examTitle = "求除数是9的商法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.QCSS9DS2_221.QCSS9DS2_221_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int baseNum = 9;// a1 * 100 + b1 * 10 + c1;
            valueABC.baseNum = n;// a1 * 100 + b1 * 10 + c1;
            
            if (posRand == 0)
            {
                A1 = (rand.Next(100, 999 + 1) / baseNum) * baseNum; //1000 * d1 + 100 * a1 + 10 * b1 + c1;
        ...
        public QCSS9DS2_221DataCreator()
        {
