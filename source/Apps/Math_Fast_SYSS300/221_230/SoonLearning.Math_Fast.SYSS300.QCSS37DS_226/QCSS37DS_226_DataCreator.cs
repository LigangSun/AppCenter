...
{
    public class QCSS37DS_226DataCreator : DataCreator
    {
        private static QCSS37DS_226DataCreator creator;

        public static QCSS37DS_226DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new QCSS37DS_226DataCreator();
        ...
        {
            this.exerciseTitle = "求除数是37的商法练习";
            this.examTitle = "求除数是37的商法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.QCSS37DS_226.QCSS37DS_226_Document.xaml";
        ...
        public QCSS37DS_226DataCreator()
        {
