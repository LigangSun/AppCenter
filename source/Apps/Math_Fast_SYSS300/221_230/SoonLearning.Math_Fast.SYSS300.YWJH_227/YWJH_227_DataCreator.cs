...
{
    public class YWJH_227DataCreator : DataCreator
    {
        private static YWJH_227DataCreator creator;

        public static YWJH_227DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YWJH_227DataCreator();
        ...
        {
            this.exerciseTitle = "移位结合法练习";
            this.examTitle = "移位结合法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YWJH_227.YWJH_227_Document.xaml";
