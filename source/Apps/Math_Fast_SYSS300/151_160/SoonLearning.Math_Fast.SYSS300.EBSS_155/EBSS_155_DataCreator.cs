...
{
    public class EBSS_155DataCreator : DataCreator
    {
        private static EBSS_155DataCreator creator;

        public static EBSS_155DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new EBSS_155DataCreator();
        ...
        {
            this.exerciseTitle = "2倍速算法练习";
            this.examTitle = "2倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.EBSS_155.EBSS_155_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 2;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
