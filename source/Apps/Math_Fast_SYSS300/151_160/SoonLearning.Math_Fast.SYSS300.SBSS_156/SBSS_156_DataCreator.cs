...
{
    public class SBSS_156DataCreator : DataCreator
    {
        private static SBSS_156DataCreator creator;

        public static SBSS_156DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_156DataCreator();
        ...
        {
            this.exerciseTitle = "3倍速算法练习";
            this.examTitle = "3倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_156.SBSS_156_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 3;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
