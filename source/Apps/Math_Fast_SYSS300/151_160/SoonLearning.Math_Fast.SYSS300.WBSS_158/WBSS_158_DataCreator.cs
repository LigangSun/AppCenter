...
{
    public class WBSS_158DataCreator : DataCreator
    {
        private static WBSS_158DataCreator creator;

        public static WBSS_158DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new WBSS_158DataCreator();
        ...
        {
            this.exerciseTitle = "5倍速算法练习";
            this.examTitle = "5倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.WBSS_158.WBSS_158_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 5;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
