...
{
    public class LBSS_159DataCreator : DataCreator
    {
        private static LBSS_159DataCreator creator;

        public static LBSS_159DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new LBSS_159DataCreator();
        ...
        {
            this.exerciseTitle = "6倍速算法练习";
            this.examTitle = "6倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.LBSS_159.LBSS_159_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 6;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
