...
{
    public class JDBS2_154DataCreator : DataCreator
    {
        private static JDBS2_154DataCreator creator;

        public static JDBS2_154DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JDBS2_154DataCreator();
        ...
        {
            this.exerciseTitle = "9的倍数法（二）练习";
            this.examTitle = "9的倍数法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JDBS2_154.JDBS2_154_Document.xaml";
