...
{
    public class QBSS_160DataCreator : DataCreator
    {
        private static QBSS_160DataCreator creator;

        public static QBSS_160DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new QBSS_160DataCreator();
        ...
        {
            this.exerciseTitle = "7倍速算法（一）练习";
            this.examTitle = "7倍速算法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.QBSS_160.QBSS_160_Document.xaml";
