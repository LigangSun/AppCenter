...
{
    public class SBSS_157DataCreator : DataCreator
    {
        private static SBSS_157DataCreator creator;

        public static SBSS_157DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SBSS_157DataCreator();
        ...
        {
            this.exerciseTitle = "4倍速算法练习";
            this.examTitle = "4倍速算法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SBSS_157.SBSS_157_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            if (posRand == 0)
            {
                ...
                A2 = 4;// (decimal)System.Math.Pow(5, n);// 1000 * d2 + 100 * a2 + 10 * b2 + c2;
            }
            else
            {
