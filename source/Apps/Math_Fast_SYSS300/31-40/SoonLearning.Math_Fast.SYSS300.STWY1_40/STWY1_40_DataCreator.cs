...
{
    public class STWY1_40DataCreator : DataCreator
    {
        private static STWY1_40DataCreator creator;

        public static STWY1_40DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new STWY1_40DataCreator();
        ...
        {
            this.exerciseTitle = "首同尾异（一）法练习";
            this.examTitle = "首同尾异（一）法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.STWY1_40.STWY1_40_Document.xaml";
