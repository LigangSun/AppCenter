...
{
    public class TZYC_38DataCreator : DataCreator
    {
        private static TZYC_38DataCreator creator;

        public static TZYC_38DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new TZYC_38DataCreator();
        ...
        {
            this.exerciseTitle = "调整余差法练习";
            this.examTitle = "调整余差法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.TZYC_38.TZYC_38_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            decimal A, B;
            int BL = rand.Next(10, 80);
            int AL = rand.Next(BL + 1, 100);
            decimal baseNum = rand.Next(minValue, maxValue + 1);
            //int baseNumInt = decimal.ToInt32(baseNum);
            baseNum -= baseNum % 100;
