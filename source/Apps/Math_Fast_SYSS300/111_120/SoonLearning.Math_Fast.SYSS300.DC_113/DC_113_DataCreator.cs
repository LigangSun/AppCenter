...
{
    public class DC_113DataCreator : DataCreator
    {
        private static DC_113DataCreator creator;

        public static DC_113DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DC_113DataCreator();
        ...
        {
            this.exerciseTitle = "叠乘法练习";
            this.examTitle = "叠乘法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.DC_113.DC_113_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            calSteps += c2.ToString();
            calSteps += ")×";
            calSteps += times.ToString();
                
            //第二步 
            calSteps += "=";
            int A1c2 = A1 * c2;
            int times10 = 10 * times;
            calSteps += A1c2.ToString();
            calSteps += "+";
            calSteps += times10.ToString();
            calSteps += "×";
            calSteps += A1c2.ToString();
       
            //第三步 
            calSteps += "=";
            int times10A1c2 = times10 * A1c2;
            calSteps += A1c2.ToString();
            calSteps += "+";
            calSteps += times10A1c2.ToString();
           
            //第四步
            int tmp0 = A1c2;
            int tmp1 = times10A1c2;
            int tmp2 = 0;
            //
