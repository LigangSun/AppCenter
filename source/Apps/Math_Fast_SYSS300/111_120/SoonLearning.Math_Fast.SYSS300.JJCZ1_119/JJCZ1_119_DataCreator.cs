...
{
    public class JJCZ1_119DataCreator : DataCreator
    {
        private static JJCZ1_119DataCreator creator;

        public static JJCZ1_119DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JJCZ1_119DataCreator();
        ...
        {
            this.exerciseTitle = "加减乘整法（一）练习";
            this.examTitle = "加减乘整法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JJCZ1_119.JJCZ1_119_Document.xaml";
