...
{
    public class JBZB_112DataCreator : DataCreator
    {
        private static JBZB_112DataCreator creator;

        public static JBZB_112DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JBZB_112DataCreator();
        ...
        {
            this.exerciseTitle = "加倍折半法练习";
            this.examTitle = "加倍折半法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JBZB_112.JBZB_112_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int c2 = 5;// rand.Next(b2 + 1, 10); //个位数
            int d1 = 0;
            int d2 = 0;
