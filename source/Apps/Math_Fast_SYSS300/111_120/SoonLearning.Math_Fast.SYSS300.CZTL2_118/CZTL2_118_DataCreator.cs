...
{
    public class CZTL2_118DataCreator : DataCreator
    {
        private static CZTL2_118DataCreator creator;

        public static CZTL2_118DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CZTL2_118DataCreator();
        ...
        {
            this.exerciseTitle = "凑整调零法（二）练习";
            this.examTitle = "凑整调零法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CZTL2_118.CZTL2_118_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            //第三步 
            calSteps += "=";
            decimal A1base = A1 * baseNum;
            decimal A1error = A1 * errors;
            calSteps += A1base.ToString();
            if (sign == 0)
            {
                calSteps += "+";
            }
            ...
            calSteps += A1error.ToString();

            decimal answer = 0;
            if (sign == 0)
            {
                answer = A1base + A1error;
            }
            else
            {
                answer = A1base - A1error;
