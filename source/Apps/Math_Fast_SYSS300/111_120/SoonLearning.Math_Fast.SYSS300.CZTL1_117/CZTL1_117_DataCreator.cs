...
{
    public class CZTL1_117DataCreator : DataCreator
    {
        private static CZTL1_117DataCreator creator;

        public static CZTL1_117DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CZTL1_117DataCreator();
        ...
        {
            this.exerciseTitle = "凑整调零法（一）练习";
            this.examTitle = "凑整调零法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CZTL1_117.CZTL1_117_Document.xaml";
