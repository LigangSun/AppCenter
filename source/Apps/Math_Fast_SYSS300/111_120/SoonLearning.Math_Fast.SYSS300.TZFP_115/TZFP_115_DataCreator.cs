...
{
    public class TZFP_115DataCreator : DataCreator
    {
        private static TZFP_115DataCreator creator;

        public static TZFP_115DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new TZFP_115DataCreator();
        ...
        {
            this.exerciseTitle = "调整分配法练习";
            this.examTitle = "调整分配法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.TZFP_115.TZFP_115_Document.xaml";
