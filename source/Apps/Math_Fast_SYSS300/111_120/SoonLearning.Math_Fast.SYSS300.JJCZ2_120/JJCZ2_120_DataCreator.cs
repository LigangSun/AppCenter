...
{
    public class JJCZ2_120DataCreator : DataCreator
    {
        private static JJCZ2_120DataCreator creator;

        public static JJCZ2_120DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JJCZ2_120DataCreator();
        ...
        {
            this.exerciseTitle = "加减乘整法（二）练习";
            this.examTitle = "加减乘整法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JJCZ2_120.JJCZ2_120_Document.xaml";
