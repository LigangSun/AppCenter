...
{
    public class TSGZ_111DataCreator : DataCreator
    {
        private static TSGZ_111DataCreator creator;

        public static TSGZ_111DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new TSGZ_111DataCreator();
        ...
        {
            this.exerciseTitle = "同数跟踪法练习";
            this.examTitle = "同数跟踪法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.TSGZ_111.TSGZ_111_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            int b = decimal.ToInt32(A2) % 10;
            int a = (decimal.ToInt32(A2) / 100) % 10;
            int c = a - b;
            bool sign = false;
            if (a > b)
            {
            ...
            else if (A2 > 1000)
            {
                ...
                answer = sum1 + sum2 + sum3 + sum4 + A1 * Csign;
            }
            else
            {
                calSteps += A1.ToString();
                ...
                answer = sum1 + sum2 + sum3 + A1 * Csign;
            }             
