...
{
    public class JSCZDataCreator : DataCreator
    {
        private static JSCZDataCreator creator;

        public static JSCZDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new JSCZDataCreator();
        ...
        {
            this.exerciseTitle = "借数凑整法练习";
            this.examTitle = "借数凑整法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.JSCZ.JSCZ_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            while (true)
            {
                ...
                //取a, b
                valueABC.values[0] = rand.Next(minValue, maxValue + 1);
                valueABC.values[1] = rand.Next(minValue, maxValue + 1);
                tmp = decimal.ToInt32(valueABC.values[1]);
                ...
                valueABC.valuesRef[0] = tmp;
                valueABC.values[1] = tmp - n;
