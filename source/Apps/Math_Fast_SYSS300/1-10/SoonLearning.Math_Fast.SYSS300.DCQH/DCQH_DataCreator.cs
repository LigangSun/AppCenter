...
{
    public class DCQHDataCreator : DataCreator
    {
        private static DCQHDataCreator creator;

        public static DCQHDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new DCQHDataCreator();
        ...
        {
            this.exerciseTitle = "等差求和法练习";
            this.examTitle = "等差求和法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.DCQH.DCQH_Document.xaml";
