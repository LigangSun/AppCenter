...
{
    public class QBJYDataCreator : DataCreator
    {
        private static QBJYDataCreator creator;

        public static QBJYDataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new QBJYDataCreator();
        ...
        {
            this.exerciseTitle = "去补进一法练习";
            this.examTitle = "去补进一法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.QBJY.QBJY_Document.xaml";
