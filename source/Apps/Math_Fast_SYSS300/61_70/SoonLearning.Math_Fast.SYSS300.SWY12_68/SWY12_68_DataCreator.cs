...
{
    public class SWY12_68DataCreator : DataCreator
    {
        private static SWY12_68DataCreator creator;

        public static SWY12_68DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SWY12_68DataCreator();
        ...
        {
            this.exerciseTitle = "首尾有1法（二）练习";
            this.examTitle = "首尾有1法（二）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SWY12_68.SWY12_68_Document.xaml";
