...
{
    public class SHWOW5_64DataCreator : DataCreator
    {
        private static SHWOW5_64DataCreator creator;

        public static SHWOW5_64DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SHWOW5_64DataCreator();
        ...
        {
            this.exerciseTitle = "首和为偶尾5法练习";
            this.examTitle = "首和为偶尾5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SHWOW5_64.SHWOW5_64_Document.xaml";
