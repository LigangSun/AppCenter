...
{
    public class SCW5_66DataCreator : DataCreator
    {
        private static SCW5_66DataCreator creator;

        public static SCW5_66DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SCW5_66DataCreator();
        ...
        {
            this.exerciseTitle = "首差尾5法练习";
            this.examTitle = "首差尾5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SCW5_66.SCW5_66_Document.xaml";
