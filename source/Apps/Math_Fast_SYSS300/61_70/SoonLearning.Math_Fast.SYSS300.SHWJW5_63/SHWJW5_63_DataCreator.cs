...
{
    public class SHWJW5_63DataCreator : DataCreator
    {
        private static SHWJW5_63DataCreator creator;

        public static SHWJW5_63DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SHWJW5_63DataCreator();
        ...
        {
            this.exerciseTitle = "首和为奇尾5法练习";
            this.examTitle = "首和为奇尾5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SHWJW5_63.SHWJW5_63_Document.xaml";
