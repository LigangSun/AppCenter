...
{
    public class SHW5_65DataCreator : DataCreator
    {
        private static SHW5_65DataCreator creator;

        public static SHW5_65DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SHW5_65DataCreator();
        ...
        {
            this.exerciseTitle = "首合尾5法练习";
            this.examTitle = "首合尾5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SHW5_65.SHW5_65_Document.xaml";
