...
{
    public class YTYH_69DataCreator : DataCreator
    {
        private static YTYH_69DataCreator creator;

        public static YTYH_69DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YTYH_69DataCreator();
        ...
        {
            this.exerciseTitle = "一同一合法练习";
            this.examTitle = "一同一合法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YTYH_69.YTYH_69_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int b = a;// rand.Next(1, 10);
            int c = rand.Next(1, 10);
            int d = 10 - c;// rand.Next(1, 10);
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            //解题步骤
            int B = decimal.ToInt32(valueMC.values[0]);
            int A = decimal.ToInt32(valueMC.values[1]);
            int a1 = A / 10;
            int b1 = A % 10;
            int c1 = B / 10;
            int d1 = B % 10;
            ...
            int ac = 100 * a * (c + 1);
            calSteps += "=";
            calSteps += ac.ToString();
            calSteps += "+";
            int ad = a * d;
            calSteps += ad.ToString();
