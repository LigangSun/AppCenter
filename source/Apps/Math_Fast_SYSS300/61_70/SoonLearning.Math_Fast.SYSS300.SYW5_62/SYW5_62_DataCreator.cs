...
{
    public class SYW5_62DataCreator : DataCreator
    {
        private static SYW5_62DataCreator creator;

        public static SYW5_62DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SYW5_62DataCreator();
        ...
        {
            this.exerciseTitle = "首异尾5法练习";
            this.examTitle = "首异尾5法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SYW5_62.SYW5_62_Document.xaml";
