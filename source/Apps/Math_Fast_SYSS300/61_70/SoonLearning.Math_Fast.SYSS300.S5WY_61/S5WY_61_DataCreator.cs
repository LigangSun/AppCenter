...
{
    public class S5WY_61DataCreator : DataCreator
    {
        private static S5WY_61DataCreator creator;

        public static S5WY_61DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new S5WY_61DataCreator();
        ...
        {
            this.exerciseTitle = "首5尾异法练习";
            this.examTitle = "首5尾异法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.S5WY_61.S5WY_61_Document.xaml";
        ...
        private String SolveSteps(valuesStruct valueMC)
        {
            ...
            calSteps += "+";
            calSteps += a_b_d.ToString();
        
            //第三步
            int a_b_2 = 2500 + b_d + a_b_d;
