...
{
    public class SWY11_67DataCreator : DataCreator
    {
        private static SWY11_67DataCreator creator;

        public static SWY11_67DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SWY11_67DataCreator();
        ...
        {
            this.exerciseTitle = "首尾有1法（一）练习";
            this.examTitle = "首尾有1法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SWY11_67.SWY11_67_Document.xaml";
