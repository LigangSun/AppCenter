...
{
    public class SCWH11_70DataCreator : DataCreator
    {
        private static SCWH11_70DataCreator creator;

        public static SCWH11_70DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SCWH11_70DataCreator();
        ...
        {
            this.exerciseTitle = "首差尾合11法练习";
            this.examTitle = "首差尾合11法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SCWH11_70.SCWH11_70_Document.xaml";
