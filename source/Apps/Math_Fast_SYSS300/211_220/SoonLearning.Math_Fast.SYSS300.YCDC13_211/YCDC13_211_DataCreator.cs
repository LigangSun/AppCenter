...
{
    public class YCDC13_211DataCreator : DataCreator
    {
        private static YCDC13_211DataCreator creator;

        public static YCDC13_211DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new YCDC13_211DataCreator();
        ...
        {
            this.exerciseTitle = "以乘代除法（十三）练习";
            this.examTitle = "以乘代除法（十三）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.YCDC13_211.YCDC13_211_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            int a1 = rand.Next(0, 6); //百位数
            int b1 = 7;// rand.Next(5, 10); //十位数
