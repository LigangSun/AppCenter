...
{
    public class ZB_215DataCreator : DataCreator
    {
        private static ZB_215DataCreator creator;

        public static ZB_215DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new ZB_215DataCreator();
        ...
        {
            this.exerciseTitle = "折半法练习";
            this.examTitle = "折半法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.ZB_215.ZB_215_Document.xaml";
