...
{
    public class CC_212DataCreator : DataCreator
    {
        private static CC_212DataCreator creator;

        public static CC_212DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new CC_212DataCreator();
        ...
        {
            this.exerciseTitle = "拆除法练习";
            this.examTitle = "拆除法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.CC_212.CC_212_Document.xaml";
