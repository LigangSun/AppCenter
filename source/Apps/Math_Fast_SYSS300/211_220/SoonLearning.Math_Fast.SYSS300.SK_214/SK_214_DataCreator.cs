...
namespace SoonLearning.Math_Fast.SYSS300.SK_214
{
    public class SK_214DataCreator : DataCreator
    {
        private static SK_214DataCreator creator;

        public static SK_214DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SK_214DataCreator();
        ...
        {
            this.exerciseTitle = "双扩法练习";
            this.examTitle = "双扩法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SK_214.SK_214_Document.xaml";
        ...
        private void GetRandomValues(SectionBaseInfo info, ref valuesStruct valueABC)
        {
            ...
            valueABC.baseNum = a1 * 100 + b1 * 10 + c1;
