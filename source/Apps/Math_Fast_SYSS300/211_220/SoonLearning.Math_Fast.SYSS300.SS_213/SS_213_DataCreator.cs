...
{
    public class SS_213DataCreator : DataCreator
    {
        private static SS_213DataCreator creator;

        public static SS_213DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new SS_213DataCreator();
        ...
        {
            this.exerciseTitle = "双缩法练习";
            this.examTitle = "双缩法测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.SS_213.SS_213_Document.xaml";
