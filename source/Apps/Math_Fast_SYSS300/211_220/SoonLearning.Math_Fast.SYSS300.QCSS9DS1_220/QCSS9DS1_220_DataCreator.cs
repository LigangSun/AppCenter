...
{
    public class QCSS9DS1_220DataCreator : DataCreator
    {
        private static QCSS9DS1_220DataCreator creator;

        public static QCSS9DS1_220DataCreator Instance
        {
            get
            {
                if (creator == null)
                    creator = new QCSS9DS1_220DataCreator();
        ...
        {
            this.exerciseTitle = "求除数是9的商法（一）练习";
            this.examTitle = "求除数是9的商法（一）测验";
            this.flowDocumentFile = "SoonLearning.Math_Fast.SYSS300.QCSS9DS1_220.QCSS9DS1_220_Document.xaml";
        ...
        public QCSS9DS1_220DataCreator()
        {
