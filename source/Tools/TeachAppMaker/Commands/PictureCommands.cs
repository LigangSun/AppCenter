...
using SoonLearning.TeachAppMaker.Controls;
...
using SoonLearning.TeachAppMaker.Properties;
    ...
    public class PictureCommands
    {
        ...
        public static void OnInsertHyperlink(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (true == hyperlinkPropertiesDlg.DialogResult)
            {
                ...
                {
                    MessageBox.Show(String.Format("{0} ({1}) :\n\r{2}", SoonLearning.TeachAppMaker.Properties.Resources.txtLoadHyperlinkFailed, hyperlinkPropertiesDlg.NavigateUri, ex), SoonLearning.TeachAppMaker.Properties.Resources.txtEditorName);
                }
            }
        ...
        public static void OnInsertPicture(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (true == imageProperties.DialogResult)
            {
                ...
                {
                    MessageBox.Show(String.Format("{0} ({1}) :\n\r{2}", Resources.txtLoadPictureFailed, imageProperties.ImageHyperlink, ex),
        ...
        public static void OnEditPictureProperties(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            if (image != null)
            {
                ...
                if (true == imageProperties.DialogResult)
                {
                    ...
                    {
                        MessageBox.Show(String.Format("{0} ({1}) :\n\r{2}", SoonLearning.TeachAppMaker.Properties.Resources.txtLoadPictureFailed, imageProperties.ImageHyperlink, ex), SoonLearning.TeachAppMaker.Properties.Resources.txtEditorName);
                    }
                }
            }
        }
